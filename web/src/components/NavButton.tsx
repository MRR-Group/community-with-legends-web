...
export default function NavButton({active, text, icon}: NavButtonProps) {
  return (
    <li
      className={cn('flex flex-row gap-1 items-center h-10 transition-colors delay-100 hover:text-primary group cursor-pointer ml-3 xs:ml-10', active ? "text-primary" : "text-text")}>
