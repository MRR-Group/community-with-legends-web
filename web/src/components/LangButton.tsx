...
export default function LangButton() {
  ...
  const [currentLang, setCurrentLang] = useLocalStorage("lang", i18n.language);
  ...
  return (
    <li className='flex flex-row gap-1 items-center h-10 transition-colors delay-100 text-text hover:text-primary group cursor-pointer ml-10' onClick={handleOnClick}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='transition-colors delay-100 stroke-text fill-text group-hover:stroke-primary group-hover:fill-primary hidden lg:block'>
        <path
